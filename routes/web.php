...
Route::get('/riwayat', [PeminjamanControllers::class, 'riwayat'])->name('user.riwayat');
...
// Perhatikan tulisan {buku} di tengah URL
Route::post('/user/buku/{buku}/pinjam', [BukuControllers::class, 'pinjam'])->name('user.buku.pinjam');
