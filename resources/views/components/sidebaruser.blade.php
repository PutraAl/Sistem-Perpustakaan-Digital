...
<button onclick="toggleSidebar()"
   ...
   {{ request()->routeIs('user.riwayat') ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
        ...
        <a href="{{ route('user.profil') }}">
            ...
            <div
                class="px-3 py-3 mt-[300px] border-t {{ request()->routeIs('user.profil') ? 'bg-blue-500 text-white' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }} flex items-center gap-2.5">
                <div
