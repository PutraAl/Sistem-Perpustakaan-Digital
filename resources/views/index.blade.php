...
<body class="font-body bg-white text-gray-800 antialiased">
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-3">
      ...
      <div class="hidden w-full md:flex md:w-auto items-center gap-1" id="navbar-main">
        <ul class="flex flex-col md:flex-row md:items-center gap-1 mt-4 md:mt-0 font-medium">
          <li><a href="#home"
              class="block px-4 py-2 text-sm text-sky-600 font-semibold rounded-lg transition">Beranda</a></li>
          <li><a href="#about"
              class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:text-sky-600 hover:bg-sky-50 transition">Tentang</a>
          </li>
          <li><a href="#features"
              class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:text-sky-600 hover:bg-sky-50 transition">Fitur</a>
          </li>
          <li><a href="#team"
              class="block px-4 py-2 text-sm text-gray-600 rounded-lg hover:text-sky-600 hover:bg-sky-50 transition">Tim</a>
          </li>
        </ul>
        <a href="{{ route('login') }}"
  ...
  <section id="home" class="pt-28 pb-20 px-4 max-w-screen-xl mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      {{-- Left: copy --}}
      <div>
        <span class="inline-block text-xs font-semibold tracking-widest uppercase text-sky-500 mb-4">Politeknik Negeri
          Batam</span>
        ...
        <p class="text-gray-500 text-lg leading-relaxed mb-8 font-light">
          Akses ribuan koleksi buku, jurnal, dan referensi akademik kapan saja dan di mana saja. Perpustakaan tanpa
          batas untuk seluruh civitas akademika Polibatam.
        </p>
      ...
      <div class="hidden lg:flex flex-col gap-4">
        <div
          class="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4 ms-10 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div
          class="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4 ms-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div
          class="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-4 ms-14 shadow-sm hover:shadow-md transition-shadow">
  ...
  <section class="border-y border-sky-100 bg-sky-50 py-12 px-4">
    <div class="max-w-screen-xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
      ...
      <div>
        ...
        <p class="text-gray-500 text-sm mt-2 tracking-wide">Kategori</p>
      </div>
      <div>
...
<div>
        ...
        <p class="text-gray-500 leading-relaxed mb-4 font-light">
          SiPerDig (Sistem Perpustakaan Digital) adalah platform pengelolaan perpustakaan berbasis web yang dikembangkan
          khusus untuk Politeknik Negeri Batam.
        </p>
        <p class="text-gray-500 leading-relaxed mb-6 font-light">
          Sistem ini memungkinkan mahasiswa untuk mencari, melihat status kesediaan buku dan melihat riwayat peminjaman
          secara digital — tanpa harus antre atau datang langsung ke perpustakaan fisik.
        </p>
        ...
        <div class="p-6 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow">
          <div class="flex items-start gap-4">
            <div class="p-3 bg-sky-50 rounded-lg shrink-0">
              <svg class="w-6 h-6 text-sky-500" fill="none" stroke="currentColor" stroke-width="1.8"
                viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p class="text-gray-500 text-sm leading-relaxed">Dari buku teks kuliah hingga semua tersedia dalam satu
                platform yang mudah diakses.</p>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-start gap-4">
            <div class="p-3 bg-white/20 rounded-lg shrink-0">
              <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
                  d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 8.25h3m-3 3.75h3" />
              </svg>
            </div>
            <div>
              <h3 class="text-white font-semibold mb-1">Peminjaman Digital</h3>
              <p class="text-sky-100 text-sm leading-relaxed">Pinjam buku hanya dengan beberapa klik. Tidak perlu antre,
                tidak perlu datang ke gedung perpustakaan.</p>
            </div>
          </div>
        </div>
        <div class="p-6 bg-gray-900 rounded-xl shadow-sm">
          <div class="flex items-start gap-4">
            <div class="p-3 bg-sky-500/20 rounded-lg shrink-0">
              <svg class="w-6 h-6 text-sky-400" fill="none" stroke="currentColor" stroke-width="1.8"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
              ...
              <p class="text-gray-400 text-sm leading-relaxed">Data pengguna dilindungi dengan sistem autentikasi dan
                enkripsi yang memenuhi standar keamanan modern.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <section id="features" class="py-20 px-4 bg-gray-50">
    <div class="max-w-screen-xl mx-auto">
      <div class="text-center mb-14">
        <span class="inline-block text-xs font-semibold tracking-widest uppercase text-sky-500 mb-4">Fitur
          Unggulan</span>
        <h2 class="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4">Semua yang Kamu Butuhkan</h2>
        <p class="text-gray-500 max-w-xl mx-auto font-light">Dirancang untuk memudahkan pengelolaan perpustakaan dan
          pengalaman membaca civitas akademika.</p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        @foreach ($features as $f)
          @if ($f['style'] === 'sky')
            <div
              class="p-6 bg-white border border-sky-100 hover:border-sky-300 rounded-xl shadow-sm hover:shadow-md transition-all duration-200">
          ...
          @elseif ($f['style'] === 'dark')
            <div
              class="p-6 bg-gray-900 border border-gray-800 rounded-xl shadow-sm hover:shadow-lg transition-all duration-200">
  ...
  <section id="team" class="py-20 px-4 bg-white">
    <div class="max-w-screen-xl mx-auto">
      <div class="text-center mb-14">
        <span class="inline-block text-xs font-semibold tracking-widest uppercase text-sky-500 mb-4">Tim
          Pengembang</span>
        <h2 class="font-display text-3xl md:text-4xl font-bold text-gray-900 mb-4">Orang-orang di Balik SiPerDig</h2>
        <p class="text-gray-500 max-w-xl mx-auto font-light">Mahasiswa Politeknik Negeri Batam yang berdedikasi
          membangun solusi digital untuk kampus.</p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
        ...
        @foreach ($team as $member)
          @if ($member['style'] === 'sky')
            <div
              class="p-6 bg-white border border-sky-100 hover:border-sky-300 rounded-xl text-center shadow-sm hover:shadow-md transition-all duration-200">
              <div
                class="w-20 h-20 rounded-full bg-sky-50 border-2 border-sky-200 flex items-center justify-center mx-auto mb-4">
              ...
              <span
                class="inline-block text-xs tracking-widest uppercase text-sky-500 font-semibold mb-3">{{ $member['role'] }}</span>
              <p class="text-gray-500 text-sm leading-relaxed font-light">{{ $member['bio'] }}</p>
            </div>
          @else
            <div
              class="p-6 bg-gray-900 border border-gray-800 rounded-xl text-center shadow-sm hover:shadow-lg transition-all duration-200">
              <div
                class="w-20 h-20 rounded-full bg-sky-500/20 border-2 border-sky-400/40 flex items-center justify-center mx-auto mb-4">
              ...
              <span
                class="inline-block text-xs tracking-widest uppercase text-sky-400 font-semibold mb-3">{{ $member['role'] }}</span>
  ...
  <section class="py-16 px-4 bg-sky-500">
    <div class="max-w-2xl mx-auto text-center">
      ...
      <p class="text-sky-100 mb-8 font-light leading-relaxed">Bergabunglah dengan ribuan mahasiswa dan dosen yang sudah
        memanfaatkan SiPerDig untuk kebutuhan akademik mereka.</p>
      <a href="{{ route('login') }}"
  ...
  <footer class="bg-gray-900 border-t border-gray-800">
    <div class="max-w-screen-xl mx-auto px-4 py-10">
      ...
      <p class="text-center text-sm text-gray-600">
        © 2026 <a href="#" class="hover:text-sky-400 transition">SiPerDig</a> · Politeknik Negeri Batam. All Rights
        Reserved.
      </p>
    </div>
  </footer>
