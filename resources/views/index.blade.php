...
<nav class="max-w-screen-xl mx-auto px-4 bg-white fixed w-full z-20 top-0 start-0 border-b border-default">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    >
      ...
      {{-- Hamburger icon --}}
      <svg id="icon-open" class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5 7h14M5 12h14M5 17h14"/>
      </svg>
      {{-- Close icon (hidden by default) --}}
      <svg id="icon-close" class="w-6 h-6 hidden" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary">
        ...
        <li>
          <a href="#" class="block py-2 px-3 text-heading rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0">Features</a>
        </li>
        <li>
...
<div id="features" class="mx-4 my-6">
  <div class="grid grid-cols-12 gap-6 max-w-screen-xl mx-auto px-4 ">
    ...
    <div class="col-span-12 md:col-span-4 border-2 border-transparent place-items-center py-3 text-white rounded-md bg-blue-400 hover:border-2 hover:border-blue-400 hover:bg-white hover:text-blue-400 ">
      ...
      <p class="text-center text-sm px-4 py-2">
        Memiliki fitur Menambah, menghapus serta mengedit buku serta Lorem ipsum dolor sit amet consectetur adipisicing elit. 
      </p>
    </div>
    <div class="col-span-12 md:col-span-4 border-2 border-transparent place-items-center py-3 text-white rounded-md bg-blue-400 hover:border-2 hover:border-blue-400 hover:bg-white hover:text-blue-400 ">
      <div class="flex justify-content-center ">
